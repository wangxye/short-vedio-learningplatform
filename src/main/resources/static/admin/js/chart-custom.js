...
if (jQuery("#editor").length) {
  ...
  /*---------------------------------------------------------------------
   Layout1 Charts
  ---------------------------------------------------------------------*/
  if(jQuery('#layout1-chart-1').length){
    am4core.ready(function() {
      ...
      var chart = am4core.create("layout1-chart-1", am4charts.XYChart);
      chart.colors.list = [am4core.color("#062B78")];
  ...
  if(jQuery('#layout1-chart-2').length){
    am4core.ready(function() {
      ...
      chart.colors.list = [am4core.color("#062B78"),am4core.color("#F9C22E"),am4core.color("#058ED9")];
  ...
  if(jQuery('#layout1-chart-3').length){
    am4core.ready(function() {
      ...
      // Create chart instance
      var chart = am4core.create("layout1-chart-3", am4charts.XYChart);
      chart.colors.list = [am4core.color("#062B78"),am4core.color("#F9C22E")];
  ...
  if(jQuery('#layout1-chart-4').length){
    am4core.ready(function() {
      ...
      // Create chart instance
      var chart = am4core.create("layout1-chart-4", am4charts.XYChart);
      chart.colors.list = [am4core.color("#062B78"),am4core.color("#F9C22E")];
  ...
  if(jQuery('#layout1-chart-5').length){
    am4core.ready(function() {
      ...
      // Create chart
      var chart = am4core.create("layout1-chart-5", am4charts.XYChart);
      chart.colors.list = [am4core.color("#062B78"),am4core.color("#F9C22E")];
  ...
  if(jQuery('#layout1-chart-6').length){
    am4core.ready(function() {
      ...
      // Create chart instance
      var chart = am4core.create("layout1-chart-6", am4charts.XYChart);
      chart.colors.list = [am4core.color("#062B78"),am4core.color("#F9C22E")];
